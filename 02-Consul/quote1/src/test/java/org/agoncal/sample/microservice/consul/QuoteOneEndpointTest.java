...
import static org.agoncal.sample.microservice.consul.QuoteOneEndpoint.QUOTE;
import static org.junit.Assert.assertEquals;

@RunWith(Arquillian.class)
@RunAsClient
public class QuoteOneEndpointTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class).addClasses(QuoteOneEndpoint.class, Application.class);
    }
