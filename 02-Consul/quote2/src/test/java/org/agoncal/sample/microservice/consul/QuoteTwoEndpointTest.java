...
import static org.agoncal.sample.microservice.consul.QuoteTwoEndpoint.QUOTE;
import static org.junit.Assert.assertEquals;

@RunWith(Arquillian.class)
@RunAsClient
public class QuoteTwoEndpointTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class).addClasses(QuoteTwoEndpoint.class, Application.class);
    }
