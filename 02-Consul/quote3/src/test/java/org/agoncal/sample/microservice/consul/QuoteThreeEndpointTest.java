...
import static org.agoncal.sample.microservice.consul.QuoteThreeEndpoint.QUOTE;
import static org.junit.Assert.assertEquals;

@RunWith(Arquillian.class)
@RunAsClient
public class QuoteThreeEndpointTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class).addClasses(QuoteThreeEndpoint.class, Application.class);
    }
