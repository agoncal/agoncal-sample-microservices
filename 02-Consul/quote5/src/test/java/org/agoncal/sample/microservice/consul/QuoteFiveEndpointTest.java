...
import static org.agoncal.sample.microservice.consul.QuoteFiveEndpoint.QUOTE;
import static org.junit.Assert.assertEquals;

@RunWith(Arquillian.class)
@RunAsClient
public class QuoteFiveEndpointTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class).addClasses(QuoteFiveEndpoint.class, Application.class);
    }
