...
import static org.agoncal.sample.microservice.consul.QuoteSixEndpoint.QUOTE;
import static org.junit.Assert.assertEquals;

@RunWith(Arquillian.class)
@RunAsClient
public class QuoteSixEndpointTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class).addClasses(QuoteSixEndpoint.class, Application.class);
    }
